...
const GuestRead = () => {
    ...
    useEffect(() => {
        ...
        const fetchArticles = async () => {
            try {
                const response = await axios.get(`https://localhost:7002/api/Contributions/faculty/${facultyName}`);
            ...
            <div className="px-4 sm:px-6 lg:px-8 py-4 min-h-screen flex justify-between">
                ...
                <div className="w-60 md:w-60 lg:w-60 flex-none overflow-auto px-1">
                    ...
                    {articles.slice(0, 4).map((article) => (
                         <div key={article.id} className="p-4 flex items-start space-x-4"   onClick={() => handleArticleClick(article.title)}>
